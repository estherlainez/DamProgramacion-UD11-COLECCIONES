...
public class Ejercicio7 {
	...
	public static void main(String[] args) {
		 ...
		 * Este mapa debe poder añadir nuevos usuarios, eliminar un usuariosegun una clave 
		...
		do {
			...
			System.out.println("1. Inicializar el map");
			System.out.println("2. Insertar nuevo elemento en map");
			System.out.println("3.Modificar en map");
			System.out.println("4.Borrar en map");
